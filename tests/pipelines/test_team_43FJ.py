...
class TestPipelinesTeam43FJ:
    ...
    def test_outputs():
        ...
        assert len(pipeline.get_run_level_outputs()) == 8+4*4*4
        assert len(pipeline.get_subject_level_outputs()) == 4*4
        ...
        assert len(pipeline.get_run_level_outputs()) == (8+4*4*4)*4
        assert len(pipeline.get_subject_level_outputs()) == 4*4*4
        assert len(pipeline.get_group_level_outputs()) == 0
        assert len(pipeline.get_hypotheses_outputs()) == 18
