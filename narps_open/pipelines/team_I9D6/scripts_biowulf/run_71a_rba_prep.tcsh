...
# --------------------------------------------------------------------------
# get list of all subj IDs for proc **FOR** a particular group, and
# **AFTER** dropping some in QC

set grp      = equalRange
set cond     = gain
set all_subj = `cat ${dir_grpqc}/list_grp_${grp}_final.txt`
...
#    foreach ses ( ${all_ses} )
        ...
        # no ${ses} var
        echo "tcsh -xf ${scr_cmd} ${subj} ${grp} ${cond} \\"    >> ${scr_swarm}
