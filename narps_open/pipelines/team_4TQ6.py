...
""" Write the work of NARPS team 4TQ6 using Nipype """
...
class PipelineTeam4TQ6(Pipeline):
    """ A class that defines the pipeline of team 4TQ6 """
    ...
    def __init__(self):
        ...
        self.run_level_contrasts = [
            ('effect_of_gain', 'T', ['trial', 'gain', 'loss'], [0, 1, 0]),
            ('effect_of_loss', 'T', ['trial', 'gain', 'loss'], [0, 0, 1])
            ]

    def get_preprocessing(self):
        """ No preprocessing has been done by team 4TQ6 """
        return None
