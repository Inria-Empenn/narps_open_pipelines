...
""" Write the work of NARPS' team R5K7 using Nipype """
...
class PipelineTeamR5K7(Pipeline):
    """ A class that defines the pipeline of team R5K7. """
    ...
    def get_run_level_analysis(self):
        """ No run level analysis has been done by team R5K7 """
        return None
