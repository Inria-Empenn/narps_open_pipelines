...
""" Write the work of NARPS team B23O using Nipype """
...
class PipelineTeamB23O(Pipeline):
    """ A class that defines the pipeline of team B23O """
    ...
    def get_preprocessing(self):
        """ No preprocessing has been done by team B23O """
        return None
